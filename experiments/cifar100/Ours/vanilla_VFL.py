...
path = '/data/data_sw/logs/VFL_base_log/cifar100/Vanilla/checkpoints/best_cifar100_' + str(currentDateAndTime) + '_' + str(aligned_samples) + '_seed_' + str(seed)
...
handler = logging.FileHandler('/data/data_sw/logs/VFL_base_log/cifar100/Vanilla/logs/' +
