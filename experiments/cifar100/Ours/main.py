...
from experiments.cifar100.Ours.grad_flip import GradReverse
from mmd import *
import logging
...
path = '/data/data_sw/logs/VFL_base_log/cifar100/Ours/checkpoints/best_cifar100_' + str(currentDateAndTime) + '_' + str(LAMBDA) + '_align_' + str(align_loss) + '_label_' + str(TRAIN_CLASSIFIER) + '_seed_' + str(seed)
