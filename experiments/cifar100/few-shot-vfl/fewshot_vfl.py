...
path = '/data/data_sw/logs/VFL_base_log/cifar100/few-shot-vfl/checkpoints/best_cifar100.ckpt_' + str(currentDateAndTime)
...
handler = logging.FileHandler('/data/data_sw/logs/VFL_base_log/cifar100/few-shot-vfl/logs/' +
