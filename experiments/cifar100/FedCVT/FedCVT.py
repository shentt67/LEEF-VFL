...
import logging
from Cifar100_coarse import CIFAR100
...
handler = logging.FileHandler('/data/data_sw/logs/VFL_base_log/cifar100/FedCVT/logs/' +
...
path = '/data/data_sw/logs/VFL_base_log/cifar100/FedCVT/checkpoints/best_cifar100.ckpt_' + str(currentDateAndTime) + '_' + str(aligned_samples)
...
class VFL_Server(nn.Module):
    def __init__(self):
        ...
        self.classifier_AB = nn.Linear(512, 20)
        self.classifier_A = nn.Linear(256, 20)
        self.classifier_B = nn.Linear(256, 20)
...
class VFL_Client(nn.Module):
    def __init__(self):
        ...
        self.Linear_unique = nn.Linear(128 * 4 * 2, 128)
        self.Linear_common = nn.Linear(128 * 4 * 2, 128)
