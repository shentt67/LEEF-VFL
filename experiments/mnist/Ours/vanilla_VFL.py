...
path = '/data/data_sw/logs/VFL_base_log/mnist/Vanilla/checkpoints/best_mnist_' + str(currentDateAndTime) + '_' + str(aligned_samples)
...
handler = logging.FileHandler('/data/data_sw/logs/VFL_base_log/mnist/Vanilla/logs/' +
