...
path = '/data/data_sw/logs/VFL_base_log/mnist/Ours/checkpoints/best_mnist_' + str(currentDateAndTime) + '_' + str(
...
handler = logging.FileHandler('/data/data_sw/logs/VFL_base_log/mnist/Ours/logs/' +
    ...
    LAMBDA) + '_align_' + str(align_loss) + '_label_' + str(TRAIN_CLASSIFIER) + '_seed_' + str(seed) + '_' + str(
    EPOCH) + '.log')
