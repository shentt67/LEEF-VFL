...
T = 0.85
# aligned samples
aligned_samples = 4000

currentDateAndTime = datetime.now()

print("The current date and time is", currentDateAndTime)
path = '/data0/data_sw/logs/VFL_base_log/mnist/few-shot-vfl/checkpoints/best_mnist.ckpt_' + str(currentDateAndTime)
...
handler = logging.FileHandler('/data0/data_sw/logs/VFL_base_log/mnist/few-shot-vfl/logs/' +
