...
handler = logging.FileHandler('/data0/data_sw/logs/VFL_base_log/fashion_mnist/FedCVT/logs/' +
...
path = '/data0/data_sw/logs/VFL_base_log/fashion_mnist/FedCVT/checkpoints/best_fashion_mnist.ckpt_' + str(currentDateAndTime) + '_' + str(aligned_samples)
