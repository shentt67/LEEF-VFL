...
path = '/data0/data_sw/logs/VFL_base_log/cifar10/few-shot-vfl-log/checkpoints/best_cifar10.ckpt_' + str(currentDateAndTime)
...
handler = logging.FileHandler('/data0/data_sw/logs/VFL_base_log/cifar10/few-shot-vfl-log/logs/' +
