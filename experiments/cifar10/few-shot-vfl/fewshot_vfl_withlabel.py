...
handler = logging.FileHandler(str(currentDateAndTime) + '_label_500.log')
...
def train(model, epoch):
    ...
    # print('Calculate gradient and get pseudo labels...')
...
def val(model, epoch, best_acc_AB=0, best_acc_server=0, classifier=False):
    ...
    with torch.no_grad():
        ...
        logger.info(
            'Epoch: {}, val loss: {:.4f}, val accuracy_A: {:.4f}, val accuracy_B: {:.4f}, val accuracy_server: {:.4f}'.format(epoch + 1,
                                                                                                            val_loss_server,
                                                                                                            val_acc_A,
                                                                                                            val_acc_B,
                                                                                                            val_acc_server))
